...
const Header = () => {
  return (
    <Container>
      <div className="my-8 px-2 h-full w-full">
        <div className="flex w-full h-4/5">
          <div className="w-1/3">
            <div className="md:w-36 md:h-36 w-28 h-28 bg-amber-300 rounded-md flex justify-center items-center">
        ...
        <div className="w-full h-1/5">
          <h2 className="text-stone-500  text-xl font-semibold">
